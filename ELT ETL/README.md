_(Udacity: Data Engineering Nano Degree) | kalexanderdev@gmail.com | 2023-02-11
_This project is a part of [Udacity's Data Engineer Nano Degree]

# PROJECT-3: Data Warehouse

## Quick start

First, get clear that dwh.cfg contains all kind of data between 
[AWS]
[DWH]
[DB]
[IAM_ROLE]
and more configuration settings
...
For creating IAM role, getting ARN and running cluster, you can use `DEND_DW_Setup.ipynb`.
...
* **create_tables.py**: This script drops existing tables and creates new ones and its runned by the command python3 create_tables.py in the console .
* **etl.py**: This script uses data in s3:/udacity-dend/song_data and s3:/udacity-dend/log_data, processes it, and inserts the processed data into DB its runned by the command python3 etl.py in the console .
